...
progressSchema.virtual('performanceLevel').get(function () {
    const self = this;
    if ((self.percentage || 0) >= 90)
        return 'excellent';
    if ((self.percentage || 0) >= 80)
        return 'good';
    if ((self.percentage || 0) >= 70)
        return 'satisfactory';
...
progressSchema.statics['findByModule'] = function (moduleId) {
...
progressSchema.statics['findRecent'] = function (userId, limit = 10) {
    return this.find({ userId })
